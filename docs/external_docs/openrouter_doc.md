...
<AccordionGroup>
  ...
  <Accordion title="How are rate limits calculated?">
    For free models, rate limits are determined by the credits in your account. If  you have
    a balance lower than {FREE_MODEL_CREDITS_THRESHOLD} credits, you will be rate limited to {FREE_MODEL_NO_CREDITS_RPD} requests per day.
    If you have a balance of at least {FREE_MODEL_CREDITS_THRESHOLD} credits, you will be rate limited to {FREE_MODEL_HAS_CREDITS_RPD} requests per day.
...
<AccordionGroup>
  ...
  <Accordion title="What free tier options exist?">
    ...
    and are usually not suitable for production use. If you have at least {FREE_MODEL_CREDITS_THRESHOLD} credits,
...
1. Free usage limits: If you're using a free model variant (with an ID ending in <code>{sep}{Variant.Free}</code>), you can make up to {FREE_MODEL_RATE_LIMIT_RPM} requests per minute.

* If your account has less than {FREE_MODEL_CREDITS_THRESHOLD} credits, you're limited to {FREE_MODEL_NO_CREDITS_RPD} requests per day.

* If you maintain a balance of at least {FREE_MODEL_CREDITS_THRESHOLD}, your daily limit increases to {FREE_MODEL_HAS_CREDITS_RPD} requests per day.
...
![Alt text](file:1d1cfe99-4c4e-4f30-b753-cec9d641b18f)
...
![Alt text](file:edcfdf5c-1a0d-4450-b945-b92515611e7d)
